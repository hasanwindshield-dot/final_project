...
export const BuyerDisputeDetailsPage = () => {
  const breadCrumbs = [
    {
      label: 'Home',
      isActive: false,
          ...
          <div className="bg-[#3939394D] rounded-[8px] p-[26px]">
            <div className="flex justify-between bg-[#393939]/90 rounded-[10px] p-[40px]">
              <div className="flex flex-col">
                ...
                <div className="mt-2">
                  <Link
                    to={`/user/${disputeDetails?.sellerId}/details`}
                    ...
                    <div className="flex flex-row">
                      <div className="rounded-[10px] items-center justify-center">
                        <img
                          ...
                          width={50}
                          height={50}
                          src={disputeDetails?.sellerAvatar || profileImage}
            ...
            <div className="bg-[#393939]/90 rounded-[10px] p-[40px] my-[20px]">
              <div className="row">
                <div className="col-md-12">
                  <p className="text-[18px] font-bold pb-10">
                    Chat with Seller
                  </p>
                  <div className="flex flex-col">
                    {disputeMessagesList &&
