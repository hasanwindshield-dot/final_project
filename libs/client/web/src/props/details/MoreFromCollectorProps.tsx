...
export const MoreFromCollectorProps = ({
  userId,
  vendorProducts,
}: {
  userId: string;
  vendorProducts: CardProps[];
}) => {
  return (
      ...
      <div className="themesflat-container">
        <div className="row">
          <div className="col-md-12">
            <div className="heading-live-auctions flex-col items-start sm:flex-row sm:items-center">
              <h2 className="tf-title pb-20 ">More From This Collector</h2>
              <Link
                to={`/user/${userId}/details`}
          ...
          <div className="col-md-12">
            ...
            >
              {vendorProducts.map((item: any, index: number) => (
