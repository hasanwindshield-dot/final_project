...
export const HeaderBackup = () => {
  ...
  const btnToggle = useRef<HTMLInputElement>(null);
  const btnSearch = useRef<HTMLInputElement>(null);
  ...
  const handleOnClick = (
    index: number | React.SetStateAction<null | number>
  ) => {
                              ...
                              <li
                                ...
                                className={
                                  pathname === submenu.links
                                    ? 'menu-item current-item cursor-pointer'
